        ...
        createApp({
            ...
            setup() {
                ...
                const formatBytes = function(bytes) {
                    if (bytes === undefined || bytes === null) return labels.sysinfo_na;
                ...
                const formatUptime = function(seconds) {
                    if (seconds === undefined || seconds === null) return labels.sysinfo_na;
                ...
                const formatFieldName = function(key) {
                    var nameMap = {
                        ...
                        'available': labels.sysinfo_table_available,
                        'free': labels.sysinfo_table_free,
                        'active': labels.sysinfo_table_active,
                        'inactive': labels.sysinfo_table_inactive,
                        'buffers': labels.sysinfo_table_buffers,
                        'cached': labels.sysinfo_table_cached,
                        'sin': labels.sysinfo_table_sin,
                        'sout': labels.sysinfo_table_sout,
                        'used_percent': labels.sysinfo_table_use_percent,
                        'hostname': labels.sysinfo_hostname,
                        'os': labels.sysinfo_os,
                        'platform': labels.sysinfo_platform,
                        'platform_version': labels.sysinfo_table_platform_version,
